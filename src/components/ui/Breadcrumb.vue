<template>
    <header v-show="currentRouteName != 'Not Found' && currentRouteName != 'Início'" class="bg-gray-300 dark:bg-gray-700 shadow">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-600 dark:text-gray-400 md:ml-2 dark:text-gray-500">{{ currentRouteName }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
