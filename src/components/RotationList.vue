<template>
    <div class="relative shadow-md sm:rounded-lg">
        <div id="revue-embed" class="p-4 mb-8 mt-2 bg-white rounded-lg shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div v-show="total" class="relative overflow-x-auto rounded-tr-lg rounded-tl-lg">
