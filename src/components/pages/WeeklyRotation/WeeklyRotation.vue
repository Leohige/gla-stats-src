            ...
            <div class="relative sm:rounded-lg">
                <div class="p-4 mb-8 mt-2 bg-gray-200 rounded-lg shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="grid md:grid-cols-3 gap-4 items-end mb-3">
                        <div class="grid sm:grid-cols-2 col-span-1 gap-4">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    type="text"
                                    name="start_date"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div v-show="total" class="bg-gray-200 rounded-bl-lg rounded-br-lg shadow-md p-6 dark:bg-gray-700 dark:border-gray-700 flex justify-center">
...
<script>
import RotationRow from "@/components/pages/WeeklyRotation/RotationRow.vue"
...
export default {
    ...
    methods: {
        ...
        paginate(page_number) {
            this.weekly_rotations_paginated = Object.freeze(this.weekly_rotations_filtered.slice((page_number - 1) * 5, page_number * 5));
        },
        search() {
